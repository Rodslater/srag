...
site21 <- read_html("https://opendatasus.saude.gov.br/dataset/srag-2021-a-2024/resource/dd91a114-47a6-4f21-bcd5-86737d4fc734")
...
site22 <- read_html("https://opendatasus.saude.gov.br/dataset/srag-2021-a-2024/resource/62803c57-0b2d-4bcf-b114-380c392fe825")
...
site23 <- read_html("https://opendatasus.saude.gov.br/dataset/srag-2021-a-2024/resource/0d78ff63-d6ca-4311-8dc8-6123cf1ca127")
...
site24 <- read_html("https://opendatasus.saude.gov.br/dataset/srag-2021-a-2024/resource/8cb52f73-0184-41d5-8a8f-87d8f415652c")
link24 <- site24 %>% html_nodes(xpath="//a[contains(text(), '.csv')]") %>% html_attr("href")
destino24<- "SRAG24.csv"
Map(function(u, d) download.file(u, d, mode="wb"), link24, destino24)   
